...
export const PoolStatusBitIndex = {
...
export const PoolStatusBitFlag = {
  Enable: 0,
  Disable: 1,
} as const;
...
export const UpdateAmmConfigParam = {
  TradeFeeRate: 0,
  ProtocolFeeRate: 1,
  FundFeeRate: 2,
  NewOwner: 3,
...
export const UpdateOperationAccountParam = {
